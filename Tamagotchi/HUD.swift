...
class HUD: SKNode {
    ...
    func createHudNodes(screenSize: CGSize) {
        ...
        hungerStatus.position = CGPoint(x: cameraOrigin.x - 120, y: cameraOrigin.y + 195)
        ...
        happyStatus.position = CGPoint(x: cameraOrigin.x - 120, y: cameraOrigin.y + 120)
